...
import com.lyp.networkhelper.util.SinTypeEvaluator;
...
public class DotsTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAnimatorSet.playTogether(dotOneJumpAnimator, createDotJumpAnimator(dotTwo, period / 6), createDotJumpAnimator(dotThree, period * 2 / 6));
