 ...
 */
public abstract class NetworkHelperLayout {

    public static NetworkHelperLayout createCustomLayout(Activity hostActivity) {
        return new CustomLoadingLayout(hostActivity);
    }

    public static NetworkHelperLayout createDefaultLayout(Activity hostActivity, View contentView) {
